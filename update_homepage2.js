...
// Replace the Pass 2 sections with corrected spacing
const startIndex = content.indexOf('{/* How I help */}');
const endIndex = content.lastIndexOf('</main>');
const before = content.substring(0, startIndex);
const after = content.substring(endIndex);

const pass2 = `{/* How I help */}
        <section id="expertise" className="site-container scroll-mt-[100px] mt-[-8px] lg:mt-[16px]">
        ...
        {/* Final CTA */}
        <section className="mb-[40px] lg:mb-[64px]">
