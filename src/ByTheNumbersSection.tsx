            ...
            <div className="flex flex-col min-[1100px]:grid min-[1100px]:grid-cols-3 gap-y-12 min-[1100px]:gap-y-0 min-[1100px]:gap-x-12">
              ...
              <div className="flex flex-col pb-8 min-[1100px]:pb-0 border-b border-divider-light min-[1100px]:border-b-0 min-[1100px]:border-r min-[1100px]:pr-12">
                ...
                <div className="flex flex-col gap-6 flex-grow">
                  <div>
                    <div className="font-sans font-bold text-[18px] text-panel-heading mb-1 tabular-nums">4 years</div>
                  ...
                  <div>
                    <div className="font-sans font-bold text-[18px] text-panel-heading mb-1 tabular-nums">350+ founder and operator interviews</div>
              ...
              <div className="flex flex-col pb-8 min-[1100px]:pb-0 border-b border-divider-light min-[1100px]:border-b-0 min-[1100px]:border-r min-[1100px]:pr-12">
                ...
                <div className="flex flex-col gap-6 flex-grow">
                  ...
                  <div>
                    ...
                    <div className="text-[15px] font-normal leading-[1.5] text-panel-body">Built across First 500 Days, Scale Playbook, engineering-leadership content, and Atoms founder stories.</div>
                  </div>
                </div>
