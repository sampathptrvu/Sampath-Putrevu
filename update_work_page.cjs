...
const replacement = `  return (
    <div className="work-page min-h-screen selection:bg-burgundy selection:text-warm-white font-sans text-warm-white relative">
      <div className="work-page-background"></div>
      <div className="work-page-background-overlay"></div>
      
      <Header />
      
      <main className="work-page-content pb-12">
...
const idx = work.lastIndexOf('  return (');
if (idx !== -1) {
  work = work.substring(0, idx) + replacement;
}
