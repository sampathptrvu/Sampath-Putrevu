...
const replacement = `          {/* Row 3 with ONE MarginNote */}
          <div className="editorial-grid group">
            <div className="editorial-reading flex flex-col gap-8 lg:grid lg:grid-cols-[1fr_1px_1fr] lg:gap-x-8 pt-[32px] pb-[8px] lg:py-[28px]">
            ...
            <div className="flex flex-col gap-[12px] ml-[16px] mb-[24px] lg:col-start-3 lg:col-span-1 lg:ml-0 lg:mb-0 lg:mt-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="editorial-margin-tick lg:hidden"></div>
              <p className="type-margin-note">I don't run paid campaigns.</p>
            </div>
          </div>`;

// Find the start of Row 3
const startStr = '{/* Row 3 with MarginNote */}';
